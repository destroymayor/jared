...
type Props = ReturnType<typeof useProjectsViewModel>;

export function ProjectsViewController({ projects }: Props) {
    return (
...
export const ProjectsBound = bind(ProjectsViewController, useProjectsViewModel);
