...
export default function Page() {
    return (
        <>
            <div className="flex min-h-[400px] flex-col gap-3 pt-10 justify-center">
                ...
                <p className="pt-2 text-sm leading-7 text-zinc-600 dark:text-zinc-400">
                    I&#39;m <b>Jared Chen</b>, a Front-end Developer working with <b>React</b>{' '}
                    and <b>Next.js</b> who enjoys building great quality and great user
                    experience products.
                </p>
