...
const FeatherIcon = (props: { className: string; children: ReactNode }) => {
...
export const BookmarksIcon = (props: any) => (
  <FeatherIcon {...props}>
...
export const CodePenIcon = (props: any) => (
  <FeatherIcon {...props}>
...
export const Edit2Icon = (props: any) => (
  <FeatherIcon {...props}>
    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
  </FeatherIcon>
);

export const Edit3Icon = (props: any) => (
  <FeatherIcon {...props}>
...
export const GithubOutlineIcon = (props: any) => (
  <FeatherIcon {...props}>
...
export const FrownIcon = (props: any) => (
  <FeatherIcon {...props}>
    <circle cx="12" cy="12" r="10"></circle>
...
export const PenToolIcon = (props: any) => (
  <FeatherIcon {...props}>
...
export const Volume2Icon = (props: any) => (
  <FeatherIcon {...props}>
...
export const VolumeXIcon = (props: any) => (
  <FeatherIcon {...props}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
