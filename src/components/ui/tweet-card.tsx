...
export const TweetSkeleton = ({
    ...
    <div
        className={cn(
            'flex size-full max-h-max min-w-72 flex-col gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 p-4',
            className
        )}
        {...props}
    >
...
export const TweetNotFound = ({
    ...
    <div
        className={cn(
            'flex size-full flex-col items-center justify-center gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 p-4',
            className
        )}
        {...props}
    >
...
export const MagicTweet = ({
  ...
  return (
      <div
          className={cn(
              'relative flex size-full flex-col gap-2 overflow-hidden rounded-lg border border-zinc-300 dark:border-zinc-700 p-4 backdrop-blur-md',
              className
          )}
          {...props}
      >
